...
class OpenTelemetrySettings(BaseModel):
    """
    OTEL settings for modl.
    """

    enabled: bool = True

    service_name: str = "modl"
...
class LogPathSettings(BaseModel):
    ...
    path_pattern: str = "logs/modl-{unique_id}.jsonl"
    """
    ...
    Example: "logs/modl-{unique_id}.jsonl"
    """
...
class Settings(BaseSettings):
    ...
    def find_config(cls) -> Path | None:
        ...
        return cls._find_config(["modl.config.yaml", "modl_agent.config.yaml"])

    @classmethod
    def find_secrets(cls) -> Path | None:
        """Find the secrets file in the current directory or parent directories."""
        return cls._find_config(["modl.secrets.yaml", "modl_agent.secrets.yaml"])
...
def get_settings(config_path: str | None = None) -> Settings:
    ...
    if config_file and config_file.exists():
        ...
        secrets_found = False
        for secrets_filename in ["modl.secrets.yaml", "modl_agent.secrets.yaml"]:
